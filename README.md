...
- `supabase_staging_validation_queries.sql` (query eseguibili per test ruoli/RLS/audit/billing in staging)
- `supabase_staging_seed_template.sql` (seed template per tenant, profili test, subscriptions e usage metrics in staging)
- `docs/staging-validation-report-template.md` (report pass/fail pronto per sign-off tecnico)
- `docs/staging-validation-execution-guide.md` (guida pratica step-by-step per esecuzione test staging)
